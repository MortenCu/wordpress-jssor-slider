...
class JssorSliderPlugin{ 
	...
	public  function  create_global_menus_for_js_slider() {
	    ...
	    $menu['sub_page']= add_submenu_page("jssor_slider", "Dashboard", __("Dashboard", jssor_slider), "manage_options", "jssor_slider",array(__CLASS__, 'jssor_slider'));

...
<?php } ?>});
	...
	<div id="slider_container_<?php echo $slider_id; ?>" style="margin:10px auto;position: relative; width:<?php echo $sliderW; ?>px; height:<?php echo $sliderH; ?>px;">
        ...
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width:<?php echo $sliderW; ?>px; height:<?php echo $sliderH; ?>px; overflow: hidden;">
			...
			<div>
				...
				<div u="caption" t="<?php echo $result2[$slides[$flag]->description_in]; ?>" t2="<?php echo $result2[$slides[$flag]->description_out]; ?>" style="position: absolute; top: 250px; left: 0px;width: 800px; height: 50px;">
                    <div style="position: absolute; top: 0px; left: 0px; width: <?php echo $sliderW; ?>px; height: 50px;background-color: Black; opacity: 0.5; filter: alpha(opacity=50);">
                    </div>
        ...
        <!-- Arrow Left -->
        <span u="arrowleft" class="<?php echo $arrowL; ?>" style="width:<?php echo $arrowWidth; ?>px; height:<?php echo $arrowHeight; ?>px; top: 45%; left: <?php echo $arrowBorder? "0" : "8"?>px;">
        </span>
        <!-- Arrow Right -->
        <span u="arrowright" class="<?php echo $arrowR; ?>" style="width:<?php echo $arrowWidth; ?>px; height:<?php echo $arrowHeight; ?>px; top: 45%; right: <?php echo $arrowBorder? "0" : "8"?>px">
        </span>
		<?php } ?>
